      ...
      <Dialog
        ...
        modalRender={() => (
          <div className={classes.modalContent}>
            ...
            <StyledTitle3 fontSize="20px">1.Общие условия</StyledTitle3>
            <StyledSubhead>
      ...
      <Dialog
        ...
        modalRender={() => (
          <div className={classes.modalContent}>
            ...
            <StyledTitle3>1. Общие положения</StyledTitle3>
            <StyledSubhead>
            ...
            <StyledSubhead>5.1. Фамилия, имя, отчество.</StyledSubhead>
            <StyledSubhead>5.2. Электронный адрес.</StyledSubhead>
            <StyledSubhead>5.3. Номера телефонов.</StyledSubhead>
            <StyledSubhead>
            ...
            <StyledTitle3>7. Цели обработки персональных данных</StyledTitle3>
            <StyledSubhead>
            ...
            <StyledSubhead>
              ...
              адрес электронной почты privacy@thismywebsite·com с пометкой
            ...
            <StyledSubhead>
              ...
              Оператором являются: – перечислите нормативно-правовые акты,
              ...
              информации&quot; от 27.07.2006 N 149-ФЗ; – уставные документы
            ...
            <StyledSubhead>
              ...
              httpsː//thismywebsite·com или направленные Оператору посредством
            ...
            <StyledTitle3>14. Заключительные положения</StyledTitle3>
            <StyledSubhead>
