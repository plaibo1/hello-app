...
export const TermsContent = ({ locale }: { locale: string | undefined }) => {
...
_Отправить письмо на iamarkov1@gmail.com_
...
**13. ПОКУПКА И ПОЛУЧЕНИЕ ЦИФРОВОГО ТОВАРА**

13.1 При покупке подписки  (оплата премиум функций приложения), пользователь получает расширенный функционал, описанный на данном сайте (https://hellomobile.app/ru/premium) и в мобильном приложении.

13.2 Получение и использование расширенного функционала осуществляется в мобильном приложении, на аккаунте пользователя, через который была совершена оплата расширенного функционала. Получение и использование премиум функций доступно в оплаченный период, дата завершения которого указана в личном кабинете пользователя.

**14. КОНТАКТЫ И РЕКВИЗИТЫ**

Общество с ограниченной ответственностью "ВИДУК ПРОДАКС"

ИНН/КПП: 6155076451/616301001

ОГРН: 1166196117669

Телефон: +7 928 189 84 18

Email: iamarkov1@gmail.com

Юридический адрес: 344000, г. Ростов-на-Дону, ул Красноармейская, д 121, этаж 4, пом 5

**15. ЗАКЛЮЧИТЕЛЬНЫЕ ПОЛОЖЕНИЯ**

15.1. Мы можем время от времени пересматривать, дополнять или изменять условия данного Соглашения. Такие изменения, как правило, не являются ретроспективными. В случае такого пересмотра, дополнения или изменения, Компания обязуется уведомить Пользователей за 0 календарных дней до момента вступления в силу таких изменений посредством публикации соответствующей информации непосредственно в самом Приложении.
...
15.2. Если иное прямо не указано в положениях настоящего Соглашения или прямо не вытекает из норм действующего законодательства, к условиям настоящего Договора применяется материальное право Российской Федерации.

15.3. Неотъемлемой частью настоящего Соглашение является Политика конфиденциальности приложения.

15.4. Если одно или несколько условий данного Соглашения утратило свою юридическую силу или признано недействительным согласно действующему законодательству, остальные условия Соглашения не теряют своей силы и продолжают действовать так, словно признанного недействительным или утратившим юридическую силу условия не существовало вовсе.

15.5. Доступ к Приложению и его Услугам предоставляется Пользователю "как есть", Мы не обещаем, не гарантируем, не подразумеваем, что Услуги и Приложение могут подходить или не подходить Вашим потребностям, целям, ожиданиям, и в связи с чем не гарантируем какого-либо специфического результата или последствия в результате использования Вами Приложения и его Услуг.

`
  const textEn = `
  By downloading or using the app, these terms will automatically apply to you – you should make sure therefore that you read them carefully before using the app. You’re not allowed to copy or modify the app, any part of the app, or our trademarks in any way. You’re not allowed to attempt to extract the source code of the app, and you also shouldn’t try to translate the app into other languages or make derivative versions. The app itself, and all the trademarks, copyright, database rights, and other intellectual property rights related to it, still belong to wedookproducts.

  wedookproducts is committed to ensuring that the app is as useful and efficient as possible. For that reason, we reserve the right to make changes to the app or to charge for its services, at any time and for any reason. We will never charge you for the app or its services without making it very clear to you exactly what you’re paying for.
  
  The Hello app stores and processes personal data that you have provided to us, to provide our Service. It’s your responsibility to keep your phone and access to the app secure. We therefore recommend that you do not jailbreak or root your phone, which is the process of removing software restrictions and limitations imposed by the official operating system of your device. It could make your phone vulnerable to malware/viruses/malicious programs, compromise your phone’s security features and it could mean that the Hello app won’t work properly or at all.
  ...
  App Store Services
  You should be aware that there are certain things that wedookproducts will not take responsibility for. Certain functions of the app will require the app to have an active internet connection. The connection can be Wi-Fi or provided by your mobile network provider, but wedookproducts cannot take responsibility for the app not working at full functionality if you don’t have access to Wi-Fi, and you don’t have any of your data allowance left.
  ...
  Along the same lines, wedookproducts cannot always take responsibility for the way you use the app i.e. You need to make sure that your device stays charged – if it runs out of battery and you can’t turn it on to avail the Service, wedookproducts cannot accept responsibility.
  
  With respect to wedookproducts’s responsibility for your use of the app, when you’re using the app, it’s important to bear in mind that although we endeavor to ensure that it is updated and correct at all times, we do rely on third parties to provide information to us so that we can make it available to you. wedookproducts accepts no liability for any loss, direct or indirect, you experience as a result of relying wholly on this functionality of the app.
  
  At some point, we may wish to update the app. The app is currently available on Android & iOS – the requirements for the both systems(and for any additional systems we decide to extend the availability of the app to) may change, and you’ll need to download the updates if you want to keep using the app. wedookproducts does not promise that it will always update the app so that it is relevant to you and/or works with the Android & iOS version that you have installed on your device. However, you promise to always accept updates to the application when offered to you, We may also wish to stop providing the app, and may terminate use of it at any time without giving notice of termination to you. Unless we tell you otherwise, upon any termination, (a) the rights and licenses granted to you in these terms will end; (b) you must stop using the app, and (if needed) delete it from your device.
  ...
  If you have any questions or suggestions about our Terms and Conditions, do not hesitate to contact us at iamarkov1@gmail.com.
  `

  const text = locale === "en" ? textEn : textRu;
...
export const PrivacyContent = ({ locale }: { locale: string | undefined }) => {
  const textRu = `
  ...
  для заключения с Администрацией сайта соглашения, иных договоров, прямо предусмотренных Политикой, иных соглашений, размещенных на страницах сайта, и их дальнейшего исполнения; 
  для улучшения качества работы сайта и приложения;
  для проведения статистических и иных исследований на основе обезличенных данных.

  Согласие дается пользователем до истечения сроков хранения соответствующей информации или документов, содержащих вышеуказанную информацию, определяемых в соответствии с законодательством РФ, после чего оно может быть отозвано пользователем путем направления соответствующего письменного уведомления Администрации на контактную почту не менее чем за 1 неделю до момента отзыва согласия. Согласие предоставляется на осуществление любых действий в отношении персональных данных, которые необходимы или желаемы для достижения указанных выше целей, включая, без ограничения: сбор, систематизацию, накопление, хранение, уточнение (обновление, изменение), использование, распространение (в т.ч. передача), обезличивание, блокирование, уничтожение, трансграничную передачу персональных данных, а также осуществление любых иных действий с персональными данными пользователя с учетом действующего законодательства РФ.
  Допустимые способы обработки данных: автоматизированный и неавтоматизированный.
  ...
  Приложение Hello использует данные о местоположении для корректной работы и выполнения основного функционала приложения. Hello использует данные о местоположении, чтобы включить отслеживание ближайших профилей пользователей, даже когда приложение закрыто или не используется. Разрешение об использовании данных местоположения необходимо для обнаружения профилей пользователей поблизости и их сохранения в список найденных профилей. Приложение не хранит данные о местоположении. Для завершения работы приложения в фоновом режиме достаточно выйти из своего аккаунта.

  Предоставление информации детьми

  Если Вы являетесь родителем или опекуном, и вы знаете, что ваши дети предоставили нам свои личные данные без Вашего согласия, свяжитесь с нами: iamarkov1@gmail.com. На нашем сервисе запрещено оставлять личные данные несовершеннолетних без согласия родителей или опекунов.
  ...
  Связаться с администрацией сайта по вопросам, связанным с политикой конфиденциальности можно по адресу: iamarkov1@gmail.com. Если вы не согласны с данной политикой конфиденциальности, вы не можете пользоваться услугами сайта и приложения Hello, в этом случае вы должны воздержаться от посещения нашего сайта и приложения.

  Пользователь (Приложения и Сайта) подтверждает, что, предоставляя свои персональные данные и давая согласие на их обработку, он действует добровольно, своей волей и в своем интересе, а также подтверждает свою дееспособность.
  `

  const textEn = `
Wedookproducts built the Hello app as a Freemium app. This SERVICE is provided by Wedookproducts at no cost and is intended for use as is.
...
For a better experience, while using our Service, we may require you to provide us with certain personally identifiable information, including but not limited to Name, Email address, User IDs, Phone number, Sexual orientation, Photos, Other info. The information that we request will be retained by us and used as described in this privacy policy.

The app does use third-party services that may collect information used to identify you.

The user who has provided his personal data to the Hello application has the right to change and delete them, as well as to withdraw his consent to their use. The period for which your personal data will be stored: the time required for the data to be used for the main activity of the application. At the end of the use of your data, the administration of the application deletes them. To access your personal data, you can contact the application administration at the following address: iamarkov1@gmail.com. We can send your personal data to a third party only with your voluntary consent, if they were transferred, then we cannot change the data in other organizations that are not related to us.
...
The Hello application uses location data for correct operation and execution of the main functionality of the application. Hello uses location data to enable user profiles nearby tracking even when the app is closed or not in use. Permission to use location data is required to detect user profiles nearby and save them to the list of found profiles.
The app does not store location data. To end the application in the background, just log out of your account.
...
If you have any questions or suggestions about our Privacy Policy, do not hesitate to contact us at iamarkov1@gmail.com.
