export const MOC_FUNCTIONS = [
  ...
  },
  {
    ...
    titleIcon: "/images/icons/fa6-solid_user-group.svg",
    description:
      "Можно создать бизнес и личный профиль, для разного рода знакомств и контактов",
    phoneImage: "/images/mockup_functions_profile.png",
  },
  {
    title: "Настройки видимости",
    titleIcon: "/images/icons/view.svg",
    description:
      "Настройка времени отображения вашего профиля другим пользователям",
    phoneImage: "/images/mockup_functions_time.png",
  },
  {
